...
const HomeFaq = ({ questionsData, loading }) => {
  const commonQuestions = questionsData?.slice(0, 6);
  const otherQuestions = questionsData?.slice(6);
            ...
            {/* <div className="accordion">
              ...
              <div className="accordion__content">
                ...
                <div className="accordion__content-text">
                  ...
                  đang học, giảng viên và mentor sẽ hỗ trợ 24/7.
                  <br />
                  <br />
              ...
              <div className="accordion__content">
                ...
                <div className="accordion__content-text">
                  ...
                  <br />
                  <br />
                  Tự tin vào bản thân, kiên trì, cố gắng và sức chiến đấu cao
                  không lùi bước, chủ động hỏi những vấn đề chưa rõ để được giải
                  đáp và hỗ trợ. <br />
                  <br />
                  Hạn chế tối đa việc nghỉ học, nếu có nghỉ thì phải xin và xem
                  lại video được ghi lại trong lúc học để hoàn thành bài tập và
                  kiến thức ngày hôm đó.
                </div>
              </div>
              <div className="accordion__content">
                <div className="accordion__content-title">
