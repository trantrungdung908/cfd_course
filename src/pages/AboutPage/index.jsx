          ...
          <div className="aboutteachers__list">
            <div className="itemteacher">
              ...
              <div className="itemteacher__info">
                ...
                <p className="itemteacher__info-des">
                  ...
                  người sáng lập CFD Circle và CFD Studio. Trong hơn 7 năm kinh
                  nghiệm trong nghề, tôi luôn tạo ra những sản phẩm chất lượng
                  cao, sáng tạo, tinh tế và phù hợp cho khách hàng trong và
                  ngoài nước, cũng như mong muốn truyền đạt lại cho các bạn trẻ
                  có đam mê và định hướng theo nghề Front-End Developer.
                </p>
              </div>
            </div>
            <div className="itemteacher">
              ...
              <div className="itemteacher__info">
                ...
                <p className="itemteacher__info-des">
                  ...
                  đại gia đình CFD Circle từ khóa CFD5. Trong quá trình học hỏi
                  và chiến đấu cùng các anh em tại đây, mình đã rút ra rất nhiều
                  kinh nghiệm thực tiễn và tìm được hướng đi phù hợp cho bản
                  thân. CFD Circle với mình không chỉ là nơi trao đến bạn những
                  kiến thức chuyên môn thực chiến, mà còn truyền một ngọn lửa
                  mãnh liệt đến từng cá nhân để thúc đẩy sự phát triển từ bên
                  trong chúng ta.
                </p>
              </div>
            </div>
            <div className="itemteacher">
              ...
              <div className="itemteacher__info">
                ...
                <p className="itemteacher__info-des">
                  Xin chào! Tôi là Huy Nguyễn - Fullstack Developer, người đồng
                  sáng lập CFD Circle &amp; CFD Studio. Với mong muốn truyền đạt
                  những kinh nghiệm thực tế có được trong hơn 5 năm đi làm cho
                  các bạn trẻ có đam mê với lập trình front-end, cũng như
                  back-end. Hi vọng tôi sẽ giúp cho các bạn có cái đầy đủ kiến
                  thức và kỹ năng để ứng tuyển vào vị trí mà bạn hướng đến.
                </p>
              </div>
            </div>
            <div className="itemteacher">
              ...
              <div className="itemteacher__info">
                ...
                <p className="itemteacher__info-des">
                  ...
                  đến việc trở thành một developer, nhất là Front-end Developer.
                  Vì vậy, mình là Huỳnh Anh Kiệt - hiện đang làm việc với vị trí
                  Software Engineer - chapter Front-End tại Kyanon Digital và
                  CFD Studio, đồng thời, là cựu học viên của CFD Circle sẽ đồng
                  hành cùng bạn trong hành trình chinh phục mong ước đó. Sau
                  thời gian dài học tập và làm việc, mình đã tích lũy được một
                  số kinh nghiệm để có thể giúp đỡ những bạn có niềm đam mê với
                  Front-end.
                </p>
              </div>
            </div>
            <div className="itemteacher">
              ...
              <div className="itemteacher__info">
                ...
                <p className="itemteacher__info-des">
                  ...
                  T.O.P Group và CFD Studio. Rất mong có thể trao đổi và truyền
                  đạt hết những kiến thức và kinh nghiệm từ những dự án thực tế
                  mà tôi học được trong quá trình làm việc đến với học viên tại
                  CFD Circle. Cùng học tập để hướng tới một Front-end Dev với
                  những sản phẩm sáng tạo, tinh tế và chuyên nghiệp nào! Rất vui
                  nếu gặp bạn ở CFD Circle.
                </p>
              </div>
            </div>
          </div>
